...
set key outside top horizontal nobox font 'Helvetica,12'
set title "(2) Média IOZONE" offset -2,-1,1
set ylabel "Mbytes/s" offset 2,1,1
set xtics ("Write" 1, "Read" 2, "ReWrite" 3, "ReRead" 4.4)
set tmargin 3.3
set bmargin 2
...
plot	'./OpenNebula/environment_dats/iozone.dat' using 1:2 with boxes ls 6 title "OpenNebula" axes x1y1\
	...
	,'./Native/environment_dats/iozone.dat' using ($1+1.4):3 with boxes ls 12 notitle "Nativo" axes x1y1\
	...
	,'./Native/environment_dats/iozone.dat' using ($1+2.4):4 with boxes ls 12 notitle "Nativo" axes x1y1\
	...
	,'./Native/environment_dats/iozone.dat' using ($1+3.4):5 with boxes ls 12 notitle "Nativo" axes x1y1\
...
#set rmargin 1
#set style fill transparent pattern 3 border
plot    './OpenNebula/environment_dats/stream.dat' using 1:2 with boxes ls 6 title "OpenNebula" axes x1y1\
                ,'./OpenStack/environment_dats/stream.dat' using ($1+0.2):2 with boxes ls 1 title "OpenStack" axes x1y1\
		,'./Native/environment_dats/stream.dat' using ($1+0.4):2 with boxes ls 12 title "Nativo" axes x1y1\
		...
		,'./Native/environment_dats/stream.dat' using ($1+1.4):3 with boxes ls 12 notitle "Nativo(ADD)" axes x1y1\
		...
		,'./Native/environment_dats/stream.dat' using ($1+2.4):4 with boxes ls 12 notitle "Nativo(ADD)" axes x1y1\
		...
		,'./Native/environment_dats/stream.dat' using ($1+3.4):5 with boxes ls 12 notitle "Nativo(ADD)" axes x1y1
...
set ylabel "MFLOPS" offset 2,1,1
set xtics ("Multiplicação de Matrizes" 1) 
set yrange [10:*]
set xrange [0:2]
set key outside bottom horizontal nobox font 'Helvetica,12'
#set style fill transparent pattern 3 border
plot './OpenNebula/environment_dats/linpack.dat' using ($0+0.6):2 with boxes ls 6 title "OpenNebula" axes x1y1\
	,'./OpenStack/environment_dats/linpack.dat' using ($0+1):2 with boxes ls 1 title "OpenStack" axes x1y1\
	,'./Native/environment_dats/linpack.dat' using ($1+0.4):2 with boxes ls 12 title "Nativo" axes x1y1
...
#set style fill transparent pattern 3 border
set key outside bottom horizontal nobox font 'Helvetica,12'
plot	'./OpenNebula/environment_dats/iperf.dat' using ($0+0.6):2 with boxes ls 6 title "OpenNebula" axes x1y1\
	,'./OpenStack/environment_dats/iperf.dat' using ($0+1):2 with boxes ls 1 title "OpenStack" axes x1y1\
	,'./Native/environment_dats/iperf.dat' using ($1+0.4):2 with boxes ls 12 title "Nativo" axes x1y1
