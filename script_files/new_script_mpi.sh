...
#---------------------------------------------------------------
#Array que define a chamada de cada função para a execução dos kernels do NAS. 
#---------------------------------------------------------------
#array=( "exec1" "exec2" "exec4" "exec8" "exec9" "exec16" "exec18" "exec20" "exec24" )
#array=( "exec24" )
array=( "exec1" "exec2" "exec4" "exec8" "exec16" )
